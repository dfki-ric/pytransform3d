...
def _general_euler_from_quaternion(
        q: npt.ArrayLike, extrinsic: bool, i: int, j: int, k: int) -> np.ndarray: ...


def intrinsic_euler_xzx_from_quaternion(q: npt.ArrayLike) -> np.ndarray: ...


def extrinsic_euler_xzx_from_quaternion(q: npt.ArrayLike) -> np.ndarray: ...
