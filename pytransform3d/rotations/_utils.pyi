...
def random_vector(rng: np.random.Generator = ..., n: int = ..., random_state: None = ...) -> np.ndarray: ...


def random_axis_angle(rng: np.random.Generator = ..., random_state: None = ...) -> np.ndarray: ...


def random_compact_axis_angle(rng: np.random.Generator = ..., random_state: None = ...) -> np.ndarray: ...


def random_quaternion(rng: np.random.Generator = ..., random_state: None = ...) -> np.ndarray: ...
