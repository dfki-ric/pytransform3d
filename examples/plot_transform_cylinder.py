...
ax = plot_cylinder(length=1.0, radius=0.3, thickness=0.1, ax_s=1.5, wireframe=False)
plot_transform(ax=ax, A2B=np.eye(4), s=0.3, lw=3)
plot_cylinder(ax=ax, length=1.0, radius=0.3, thickness=0.1, A2B=A2B, wireframe=False)
