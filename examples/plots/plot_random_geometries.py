...
box2origin = random_transform(rng=rng)
...
cylinder2origin = random_transform(rng=rng)
...
ellipsoid2origin = random_transform(rng=rng)
...
capsule2origin = random_transform(rng=rng)
...
cone2origin = random_transform(rng=rng)
