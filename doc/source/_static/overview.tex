...
\node[draw,shape=rectangle,thick,rounded corners,fill=cyan!15] (sixd) at (3.3,10.9) {\begin{minipage}{4.6cm}\textbf{6D representation}\\[0.3em]
$(\boldsymbol{a}_1, \boldsymbol{a}_2) \in \mathbb{R}^6$\\[0.3em]
\texttt{rotation\_6d}\\[0.3em]
shape (6,)
\end{minipage}};
...
\draw[<->] (sixd) -- (rotmatarray) node[near start,sloped,below] {Gram-Schmidt};
\end{tikzpicture}
\end{preview}
\end{document}